class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.for(:sign_up) << :name << :location << :organization << :bio << :interestGroups << :group_id << :requested_group_name << :periodicity_id << :last_email_send << :avatarUrl
